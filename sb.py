...
boteater = LINE('EtQQVnOtTROY5jCiGGZf.StMJ2yMSv7H5XrT17lGnZW.FyEjzCJIjjEbcddcPrnzmOS/fk+wzEy/RTX/fUklBpE=')##LOGIN LEWAT TOKEN           
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == 'help':
                    boteater.sendMessage(to, "=== WAHYUDI === \nbotmenu \nsetting \nselfmenu \ngrupmenu \nmedia \ntokengen \nanimenew \nanimelist")
